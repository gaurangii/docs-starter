...
```
https://api.v7. Aura.com/whatsapp-automation/wa/send-template?apiKey=*API KEY*
```
...
```
curl --location --request POST '<https://api.v7. Aura.com/whatsapp-automation/wa/send-template?apiKey=> *Shared Separately*' \\
