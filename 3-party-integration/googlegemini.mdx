---
title: "Integrate  Aura with Google Gemini"
description: "This page provides an in-depth guide on integrating  Aura with Google Gemini.
...
The integration of Google Gemini with  Aura brings cutting-edge generative AI capabilities to your chatbot experience. Gemini, Google’s state-of-the-art multimodal LLM (Large Language Model), enables natural, context-aware, and multi-turn conversations that go beyond standard automation.

This guide outlines the step-by-step process to integrate Google Gemini with  Aura.
...
Congratulations\! You have successfully integrated  Aura with Google Gemini\!
...
<AccordionGroup>
  <Accordion title="Which Gemini models are supported in  Aura?">
  ...
  <Accordion title="Can I use both OpenAI and Gemini models in one  Aura account?">
