...
### **Integrate  Aura with Google Contacts**

 1. **Login to  Aura:**
    - Start by logging into your  Aura account.
 2. **\
    Navigate to the Bot:**
 ...
 6. **Login to Google Account:**
    - You will be prompted to log into your Google account. Ensure you use the Google account you want to link with  Aura.
 7. **\
    Grant Permissions:**
    - Follow the on-screen instructions to grant  Aura the necessary permissions to access your Google Contacts.
 8. **Map the Questions:**
...
11. **Check the Contact Section:**
    - In the "Contact" section of your  Aura dashboard, you will see the demo leads created by the integration.
