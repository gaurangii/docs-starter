---
title: "Integrate  Aura with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  Aura, you will need:

- A ** Aura** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  Aura to collect payments via Razorpay.

#### **Step 1: Login to  Aura and Select WhatsApp Bot**

1. Go to [ Aura](https://www. Aura.com/) and log into your account.
...
To connect Razorpay with  Aura, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
#### **Step 4: Connect Razorpay to  Aura**
...
4. Go back to  Aura and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  Aura bot editor.
2. \
...
Your  Aura WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   