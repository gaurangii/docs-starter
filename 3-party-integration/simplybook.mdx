---
title: "Integrate  Aura with SimplyBook"
description: "This page contains the stepwise tutorial for the integration of SimplyBook with  Aura."
---

**\
Access Your  Aura Account**

- Log in to your  Aura account and select the bot you wish to integrate with SimplyBook.

**\
Navigate to Third-Party App Integrations**

- Go to the "Third-Party App Integrations" section in your  Aura account.
