---
title: "Integrate  Aura with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  Aura."
---

#### **Integration of Google Analytics with  Aura**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  Aura chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  Aura:

**Step 1: Log in to  Aura**

1. Navigate to your [ Aura account](https://www. Aura.com/).
...
To connect Google Analytics to your  Aura account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  Aura**

1. Go back to the  Aura integration page where you clicked **Connect** for Google Analytics.
