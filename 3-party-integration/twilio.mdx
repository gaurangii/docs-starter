---
title: "Integrate  Aura with Twilio"
description: "This page provides a step-by-step guide on integration of  Aura with Twilio"
---

### **Why use Twilio?**

Integrate Twilio with your  Aura chatbot to enable seamless SMS and WhatsApp messaging. This allows your chatbot to reach users directly on their phones, improving engagement, outreach, and customer satisfaction. Whether you're sending order updates or automating lead follow-ups, Twilio ensures reliable delivery.
...
- Your  Aura chatbot is published and assigned to a valid channel.

---

### **Steps to Integrate  Aura with Twilio:**

#### **Step 1: Going to Integration on  Aura**

1. Sign into your  Aura account and choose the chatbot. Go to "Third Party Apps Integrations"
2. \
...
#### **Step 2: Getting the Information from Twilio.**
 ...
 5. \
    Copy and paste the same tokens in the  Aura Applciation.
 ...
 7. \
    ...
    - Set the name as " Aura".
    - Copy the code in  Aura Twilio Integration Screen, and paste it in the Request URL box.
 8. \
    This will create a new application.
 9. Click on the application to see the **TwiLM App SID**. Copy the ID over to the  Aura platform.
10. \
...
14. \
    Copy the same in your  Aura Account.
15. \
...
17. \
    Make sure both the "Voice Configuration", and scrolling down, the Messaging Configuration have the URL as copied from  Aura.
18. \
...
<AccordionGroup>
  <Accordion title="Does  Aura offer SMS services with Twilio">
    No,  Aura only offers Twilio with Voice calling configuration.
  </Accordion>
