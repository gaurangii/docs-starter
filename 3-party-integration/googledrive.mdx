---
title: "Integrate  Aura with Google Drive"
description: "This page contains all the step by step information of how you can integrate the Google Drive with  Aura."
---

### **Introduction**

Integrating Google Drive with  Aura allows you to utilize external resources for training your AI chatbot.

### **Step-by-Step Integration Process**

#### **1. Login to  Aura**

- Navigate to home page  to log in to your  Aura account.
...
- Review the permissions requested by  Aura.
...
- Contact  Aura support if you encounter any issues.
