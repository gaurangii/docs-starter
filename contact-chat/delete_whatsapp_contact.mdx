...
This API endpoint allows you to update the status of users in your  Aura application.

**Endpoint URL:** `https://api.v7. Aura.com/inbox/users/status-update`
...
```
curl 'https://api.v7. Aura.com/inbox/users/status-update' \
  -X 'PUT' \
