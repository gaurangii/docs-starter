...
<AccordionGroup>
  <Accordion title="How to install website bot using javascript">
    Copy the Javascript code from the  Aura app & Go to
    ...
    **Please Note**
    ...
    2. Make sure  Aura should be the last script to execute, as some scripts may override the  Aura script.
  </Accordion>
  <Accordion title="How to install a bot on wordpress website">
    After you have logged into your  Aura account, Go to the Bots Tab, select the desired Bot, and navigate to the Install section.
    ...
    3. Go to Plugins \> Add new \> Search  Aura \> Install now \> Activate plugin"
    4. Install the " Aura" Plugin and then activate the same.
    5. Upon activating the Plugin, you will be redirected to the plugins page with the confirmation message "Plugin Activated."
    6. Once your Plugin is activated, paste the Bot Penguin API key in the Box named " Aura Snippet" that you Copied from your  Aura account.
    7. Save the Settings, and you are all set.  Aura has been integrated into your website.
  </Accordion>
  <Accordion title="Bot is not showing up upon activation of wp-rocket plugin">
    If you have both wp-rocket and  Aura Plugin/Script added to your WordPress site, You may face the issue of the  Aura not showing up on the website.
    ...
    3. Add the ` Aura` bot script here under `Exclude Java Script Files` option, and done\!
  ...
  <Accordion title="What is the minimum browser version requirement for the  Aura website bot">
     Aura is a JS-based software. Hence your browser must support the Java Script. The minimum requirement for some renowned browsers are as follows:
  ...
  <Accordion title="How to resolve latency issues on my website when I have the chatbot installed">
    ...
    <script>
        ...
        scriptEle.src = ('src', 'https://cdn. Aura.com/ Aura.js');
        scriptEle.setAttribute('id', ' Aura-messenger-widget');
    ...
    <img
      src="/images/how-botpenguin-works/bot-installation-faq/204.bot_installation_faqs__Aura_resource_centre-1.png"
      alt="204 Bot Installation Faqs  Aura Resource Centre 1 Pn"
      title="204 Bot Installation Faqs  Aura Resource Centre 1 Pn"
      style={{ width:"77%" }}
    />
