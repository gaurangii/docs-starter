...
2. Click on the "API Setup" option under the "WhatsApp" section.
   ...
   ![227 Getting All The Necessary Details From Meta Develo 1 Pn](/images/platform-guidelines-training/getting-necessarydetails/227.getting_all_the_necessary_details_from_meta_develo-1.png)
...
3. Copy both the "Phone number ID" and "WhatsApp Business Account ID" (WABA ID) displayed on the page.
   ...
   ![227 Getting All The Necessary Details From Meta Develo 2 Pn](/images/platform-guidelines-training/getting-necessarydetails/227.getting_all_the_necessary_details_from_meta_develo-2.png)

#### **Step 4: Copy the "System User token" that you generated. if you missed the same, Visit below page**

[🦸‍♀️Assign System User to WhatsApp Account](https://help. Aura.com/platform-guidelines-and-training/whatsapp-bot-creation-with-manual-onboarding/assign-system-user-to-whatsapp-account)
...
Please ensure to keep these details secure and do not share them with unauthorized parties. If you encounter any difficulties or have further questions regarding the Meta Developer Dashboard, please refer to the official Meta documentation or contact  Aura support team for assistance.